...
pairs = [
    ...
    [
        ...
        ["Crazy_Tech has many great articles with each step explanation along with code,"
         " you can explore"]
    ],
    [
        r"quit",
...
def chat():
    print("Hi! I am a chatbot created by Softek for your service")
